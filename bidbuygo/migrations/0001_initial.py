    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product_type', models.CharField(choices=[('Regular', 'Regular'), ('Thrift', 'Thrift')], default='Regular', max_length=50)),
                ('product_condition', models.CharField(choices=[('New', 'New'), ('Refurbished', 'Refurbished'), ('Used', 'Used')], max_length=50)),
                ('size', models.CharField(choices=[('XS', 'Extra Small'), ('S', 'Small'), ('M', 'Medium'), ('L', 'Large'), ('XL', 'Extra Large'), ('XXL', '2X Large'), ('3XL', '3X Large'), ('Free', 'Free Size')], default='M', max_length=10)),
                ...
                ('seller', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='bidbuygo.seller')),
            ],
            options={
